...
public class HourtyEmployee extends Employee{
	...
	public HourtyEmployee(String ssn, String firstName, String lastName, String birthDate, String phone, String email,double wage,double workingHours) {
	...
	public void display() {
		System.out.println("ssn: "+this.getSsn()+", "+"firstName: "+this.getFirstName()+", "+"lastName: "+this.getLastName()+", "+"birthDate: "+this.getBirthDate()+", "+"phone: "+this.getPhone()+", "+"email: "+this.getEmail()+", "+
				"wage: "+this.getWage()+", "+"workingHours: "+this.getWorkingHours());
	}
